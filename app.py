...
# Directing users through login manager
...
# Home page route method determines user role and routes user to appropriate pages
@app.route('/login', methods=['GET', 'POST'])
def login():
    default_route_function = 'student_view_all'
    default_student_route_function = 'student_view'

    # If the user is a manager or admin they are directed to these pages
    if request.method == 'GET':
        # Determine where to redirect user if they are already logged in, if they are a student, they are redirected
...
# Admin and manager required login to view all students
...
# Admin, manager, student roles required to login and view a student
...
# If admin or manager, have access to creating a student
...
# if admin or manager, can update a student's information
...
# If admin, can delete student information
...
# Handles errors and redirects to this page
